...
import com.jingna.workshopapp.util.ImageUtils;
...
public class WXShare {
    ...
    public static final String APP_ID = "wxc67fb969dcedd5a0";
...
//        Logger.i("text shared: " + result);
    ...
    public void shareUrl(final String url, final String title, final String subtitle, final String pic) {
        ...
        imageUtils.getImage(NetUrl.BASE_URL + pic, new HttpCallBackListener() {
            @Override
