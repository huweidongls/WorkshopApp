package com.jingna.workshopapp.util;
...
import com.jingna.workshopapp.page.SMSLoginYzmActivity;

public class SMSCodeTimeCount extends CountDownTimer {

    private SpannableString msp = null;
    private int timeNum = 60;
    private SMSLoginYzmActivity activity;
    ...
    public SMSLoginYzmActivity getActivity() {
        return activity;
    }

    public void setActivity(SMSLoginYzmActivity activity) {
