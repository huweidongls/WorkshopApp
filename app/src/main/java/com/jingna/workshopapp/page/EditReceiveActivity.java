...
import com.jingna.workshopapp.bean.AddressGetOneBean;
...
public class EditReceiveActivity extends BaseActivity {
    ...
    private void initData() {
        ...
        map.put("id", id);
        ViseUtil.Get(context, "/MemAdress/getOne", map, new ViseUtil.ViseListener() {
            @Override
            public void onReturn(String s) {
                Gson gson = new Gson();
                AddressGetOneBean bean = gson.fromJson(s, AddressGetOneBean.class);
